...
const DM_TEMPLATES = {
  pt: {
    ...
    giveValue:  `Olá {creator},\n\nBoa, respondeste. Tenho uma ideia específica para o teu caso, mas o quadro completo mostra-se melhor numa call rápida de 15 minutos. Quando podes?\n\nAbraço,\n{sender}`,
    bookNudge:  `Olá {creator},\n\nO passo óbvio agora é falarmos. 15 minutos, só a trocar ideias. Passo-te uns horários?\n\nAbraço,\n{sender}`,
  ...
  en: {
    ...
    giveValue:  `Hey {creator},\n\nGood, you replied. I've got a specific idea for your case, but the full picture lands better on a quick 15 minute call. When works?\n\nCheers,\n{sender}`,
    bookNudge:  `Hey {creator},\n\nThe obvious next step is a quick talk. 15 minutes, just trading ideas. Want me to send a few times?\n\nCheers,\n{sender}`,
  ...
  es: {
    ...
    giveValue:  `Hola {creator},\n\nBien, respondiste. Tengo una idea específica para tu caso, pero el cuadro completo se ve mejor en una llamada rápida de 15 minutos. ¿Cuándo puedes?\n\nUn abrazo,\n{sender}`,
    bookNudge:  `Hola {creator},\n\nEl paso obvio ahora es hablar. 15 minutos, solo intercambiar ideas. ¿Te paso algunos horarios?\n\nUn abrazo,\n{sender}`,
