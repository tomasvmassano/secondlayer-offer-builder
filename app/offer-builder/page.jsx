...
export default function OfferBuilder() {
  ...
  const handleCreatorSelect = (creator) => {
    ...
    const demoparts = [ae.gender, ae.age, ae.location].filter(Boolean);
    setForm({
        ...
        {!result && <div>
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 13, color: "#4a4840", margin: 0, maxWidth: 460 }}>
              Seleciona um creator do CRM. Os dados são preenchidos automaticamente.
            </p>
          </div>
          ...
          {selectedCreator && (
            <div style={{ marginBottom: 20, padding: "12px 16px", borderRadius: 8, background: "#080604", border: "1px solid #141210", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button onClick={() => { setSelectedCreator(null); setForm({}); setStep(0); }} style={{ padding: "4px 10px", borderRadius: 3, border: "1px solid #1e1b17", background: "transparent", color: "#6b6860", fontSize: 10, cursor: "pointer", fontFamily: "inherit" }}>Trocar</button>
            </div>
          )}

          {selectedCreator && <div style={{ display: "flex", gap: 2, marginBottom: 32 }}>
